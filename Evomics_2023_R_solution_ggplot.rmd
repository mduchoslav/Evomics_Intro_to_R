...
author: "Janina Rinke, Kartik Singhal, Milos Duchoslav"
date: "May 2023"
output:
  html_document:
   code_folding: show
...
NPQ_summary_long <- NPQ_summary_long %>%
  unite(condition_genotype, condition_info, genotype, sep = "_")

# Create the line plot
p7 <- ggplot(NPQ_summary_long, aes(x = Timepoint, y = NPQ, color = condition_genotype)) +
  geom_point() +
